...
const QuestionnaireComponent = ({
  ...
  const element = elementInstance as CustomInstance;
  const { label, helperText, required, placeHolder, conditions } =
  ...
  const updateValue = useCallback(
    (newValue: string) => {
      ...
      const errors = NumberFieldQuestionnaireElement.validate(
        element,
        newValue,
      );
      setErrors(errors);
...
const PropertiesComponent = ({
  ...
  function applyChanges(values: z.infer<typeof propertiesSchema>) {
    const { label, helperText, required, placeHolder, conditions } = values;
    ...
    toast({
      title: "Sucesso",
      description: "Campo numérico atualizado com sucesso",
    });
...
export const NumberFieldQuestionnaireElement: QuestionnaireElement = {
  type,
  construct: (id: string) => ({
    id,
    type,
